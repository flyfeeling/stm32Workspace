...
/*public variable*/
extern w25qxx_description_strutct w25qxx ;
...
uint8_t W25QXX_ID(void);
uint32_t W25QXX_JEDEC_ID(void);
uint32_t W25QXX_MFTR_DEVICE_ID(void);
uint64_t W25QXX_UNIQUE_ID(void);
