...
//	eraseinitstruct.Banks = 
  eraseinitstruct.PageAddress = Add*FLASH_PAGE_SIZE;
...
{
  /* USER CODE BEGIN 5 */
	#define FLASH_PROGRAM_TIME	0xFFFFF
	#define FLASH_ERASE_TIME		0xFFFFF
  switch (Cmd)
  {	
    case DFU_MEDIA_PROGRAM:
		buffer[1] = (uint8_t)(FLASH_PROGRAM_TIME << 0);;
    buffer[2] = (uint8_t)(FLASH_PROGRAM_TIME << 8);
    buffer[3] = 0;
    break;

    case DFU_MEDIA_ERASE:
		buffer[1] = (uint8_t)(FLASH_ERASE_TIME << 0);
