...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OV7670_SCL_Pin|OV7670_SDA_Pin|SPI2_CS_Pin|SPI1_CS_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = OV7670_SCL_Pin|OV7670_SDA_Pin|LCD_BL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
